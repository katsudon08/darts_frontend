                    ...
                    <div className="h-full w-full flex flex-col justify-between space-y-4 md:space-y-2 md:py-2">
                        ...
                        {Array.from({ length: 3 }).map((_, i) => (
                            <div className="h-full w-full flex flex-row bg-gray-50 rounded-md border border-slate-400 shadow-md" key={i}>
                                ...
                                <div className="h-full w-3/4 border-l-2 border-r-2 md:border-r-1 border-slate-300" ></div>
                                <div className="h-full w-2/4 border-l-1 border-r-2 border-slate-300 hidden md:flex" ></div>
                                <div className="h-full w-1/4" ></div>
                            </div>
                        ))}
                    </div>
